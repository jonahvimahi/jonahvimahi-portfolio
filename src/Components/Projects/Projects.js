...
import bugTrackerScreenShot from "../../Content/images/bug-tracker-screenshot.png";
import "./Projects.css";
...
function Projects() {
	return (
		<div className="projectsPage">
			...
			<div id="projects">
				<div className="projectBox" id="bugTracker">
					<div className="projectTitle">
						<h1>Bug Tracker</h1>
					</div>
					<div id="bugTrackerScreenShotDiv">
						<img
							className="projectScreenShot"
							id="bugTrackerScreenShot"
							src={bugTrackerScreenShot}
							alt="ScreenShot"
						/>
					</div>
					<div id="projectLinks">
						<a
							href="https://www.youtube.com/watch?v=IcNFLfduYWM"
							id="bugTrackerLink"
							target="_blank"
							rel="noreferrer"
						>
						...
						<a
							href="https://github.com/jonahvimahi/capstone-buggy/tree/main"
							id="bugTrackerGitHubLink"
							target="_blank"
							rel="noreferrer"
						>
					...
					<div className="projectDescription">
						<h1>About</h1>
						<p>
							This is a personal project for me to keep track of bugs I find in
							my code
						</p>
						<p>Made with: MERN Stack | MaterialUI | Firebase </p>
					</div>
				</div>
				<div className="projectsRowTwo">
					...
					<div className="projectBox" id="olsoMusic">
						...
						<div className="projectDescription">
							...
							<p>
								...
								requested a clean and simple UI with links to all his socials
								and a small showcase of his music.
							</p>
